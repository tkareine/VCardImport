...
struct VCardErrors {
  ...
  static func addressBookAccessDeniedOrResticted() -> NSError {
    return vcardError(code: 5, failureReason: "Access error", description: "The application needs access to Contacts, but the access is denied or restricted. Please allow access in System Settings.")
  }
